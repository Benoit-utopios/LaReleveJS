document.addEventListener("DOMContentLoaded", () => {
  ...
  addCardButtons.forEach((button) => {
    button.addEventListener("click", () => {
      const list = button.closest(".list") as HTMLElement;
      const cardsContainer = list?.querySelector(".cards") as HTMLElement;
      ...
      if (currentIndex < allLists.length - 1) {
        ...
        moveBtn.addEventListener("click", () => {
          ...
          const nextCardsContainer = nextList?.querySelector(".cards") as HTMLElement;
